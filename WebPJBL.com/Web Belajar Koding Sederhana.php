...
<html lang="en">
  <head>
    ...
    <title>Web Belajar Koding Dasar</title>
    <!-- Bootstrap -->
...
<img src="Untitled design (19).png" width="61" height="59" alt=""/>
...
<hr>
    <h2 class="text-center">MATERI PEMBELAJARAN&nbsp;</h2>
    <hr>
    <div class="container">
        ...
        <div class="col-md-4 pb-1 pb-md-0">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <p class="card-text">deskripsi materi</p>
    ...
    <hr>
    <h2 class="text-center">NEW UPDATE COMING SOON&nbsp;&nbsp;</h2>
    <hr>
<hr>
<footer class="text-center">
  <div class="container">
        <div class="row">
          <div class="col-12">
            <p>Made By Arsa Pradityo Nugroho&nbsp;</p>
          </div>
        </div>
      </div>
    </footer>
